...
Technically it is a default [Laravel 5.1 LTS](https://github.com/laravel/laravel) application integrated with [JSON API implementation](https://github.com/neomerx/json-api).
